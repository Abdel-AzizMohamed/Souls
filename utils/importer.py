...
def import_callable(obj: object, import_path: str) -> Callable[..., None]:
    """
    ...
    if import_path.split(":")[-1].find(".") != -1:
        return import_method(obj, import_path)
...
def import_method(obj: object, method_path: str) -> Callable[..., None]:
    """
    ...
    module_method = getattr(obj, method_name)
